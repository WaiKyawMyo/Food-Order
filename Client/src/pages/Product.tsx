...
function Product({children}:Props) {
  ...
  return (
    <>
     {
        !userInfo?  <div className=" absolute z-60 w-full Top- left-[-10px] h-screen top-[0px]  backdrop-blur-2xl">
                    ...
                    <div className="relative p-4 bg-gray-600 rounded-lg shadow mt-6 md:p-8">
                        ...
                        <div className="justify-between items-center pt-0 space-y sm:space-y-0">
                            ...
                            <div className="items-center space-y-4 sm:space-x-4 sm:flex sm:space-y-0">
                                ...
                                <Link to={'/'} id="confirm-button" type="button" className="py-2 px-4  text-sm font-medium text-center text-white rounded-lg bg-primary-700 w-1/2 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-gray-700 border-gray-500 hover:text-white hover:bg-gray-800 focus:ring-gray-600">Sign in</Link>
                            </div>
                        </div>
                    </div>
                </div>
