...
import { useCrateSetMutation, useGetallMenuMutation } from "../../Slice/ApiSclice/AdminApi";
...
<ToastContainer
      ...
      {/* Display Area */}
          ...
          ?<span className=" mx-3 dark:text-gray-500 text-black ">{displayedDesigns.join(', ')}</span> 
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-gray-700 p-6 rounded shadow-lg min-w-[300px]">
            ...
            <div className="mb-4 space-y-2">
              <span onClick={()=>clickDrink('Add Ons')} className=" p-2 border rounded-2xl mr-2 cursor-pointer hover:bg-blue-500 ">Add Ons</span> <span onClick={()=>clickDrink('Drink')} className="p-2 border rounded-2xl mr-2 cursor-pointer hover:bg-blue-600 ">Drink</span> <span onClick={()=>clickDrink('Main Dish')} className="p-2 border rounded-2xl mr-2 cursor-pointer hover:bg-blue-500 ">Main Dish</span>
              <div className="space-y-2 mt-4">
                {alldata.map((option:Itable) => (
                <div className="flex items-center">
                  <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 mr-2 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
